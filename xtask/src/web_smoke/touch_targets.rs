...
fn run_checks(
    ...
    // previews, the fight screen's parallax) can never satisfy the
    // byte-identical-frames stability streak with the clock running --
    // freeze `Time<Virtual>` around each stabilize+measure step, the same
