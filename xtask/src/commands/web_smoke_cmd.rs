...
pub const SUBCOMMANDS: &[(&str, &str)] = &[(
    "--scenario",
    "Run a named scenario (cold-menu, gold-journey, accessibility-settings-reload, reduced-motion-fight, fight-palette-desktop, fight-palette-phone). Usage: cargo xtask web-smoke --scenario cold-menu [--update-baselines]",
)];
